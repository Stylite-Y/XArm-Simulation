...
x_0 &= x_r+l_0S_0\\
z_0 &= z_r-l_0C_0\\
x_1 &= x_r+L_0S_1+l_1S_{0,1}\\
z_1 &= z_r-L_0C_1-l_1C_{0,1}\\
x_2 &= x_r+L_0S_1+L_1S_{0,1}+l_2S_{0,1,2}\\
z_2 &= z_r-L_0C_1-L_1C_{0,1}-l_2C_{0,1,2}\\
x_3 &= x_r+L_0S_1+l_1S_{0,3}\\
z_3 &= z_r-L_0C_1-l_1C_{0,3}\\
x_4 &= x_r+L_0S_1+L_1S_{0,3}+l_2S_{0,3,4}\\
z_4 &= z_r-L_0C_1-L_1C_{0,3}-l_2C_{0,3,4}\\
x_5 &= x_r+l_3S_{0,5}\\
z_5 &= z_r-l_3C_{0,5}\\
...
$$
\begin{aligned}
&m_{x\theta}=2L_0C_0(m_1+m_2)+m_0l_0C_0+\displaystyle\sum_{k=lg,rg,la,ra}
...
&\mathrm{M}_{b,b} =
\begin{bmatrix}
m_{0,1,2,1,2,3,4,3,4} &0 &m_{x\theta}\\
0 &m_{0,1,2,1,2,3,4,3,4} &m_{x\theta}\\
m_{x\theta} &m_{x\theta} &m_{x\theta\theta}\\
\end{bmatrix}\\
\\
&\mathrm{M}_{b,lg} =
\begin{bmatrix}
...
$$
\begin{aligned}
&m_{b\theta} = 2L_0S_0(m_1m_2)+m_0l_0S_0+\displaystyle\sum_{k=lg,rg,la,ra}(L_{k1}m_{k2}C_{0,k1}+l_{k1}m_{k1}S_{0,k1}+l_{k2}m_{k2}S_{0,k1,k2})\\
\\
&m_{odd,\theta}=L_{k1}m_{k2}S_{0,k1}+l_{k1}m_{k1}S_{0,k1}+l_{k2}m_{k2}S_{0,k1,k2}\\
\\
&m_{eve,\theta}=l_{k2}m_{k2}S_{0,k1,k2}\\
\\
&m_{\theta\theta1}=L_0(L_{k1}m_{k2}S_{k1}+l_{k1}m_{k1}S_{k1}+l_{k2}m_{k2}S_{k1,k2})\\
\\
&m_{\theta\theta2}=m_{k2}l_{k2}(L_0S_{k1,k2}+L_{k1}S_{k2})\\
\\
&m_{\theta\theta3}=m_{k2}l_{k2}L_{k1}S_{k2}\\
\\
&\mathrm{C}_b=
\begin{bmatrix}
-(m_{b\theta})\dot{\theta}_0^2-
\displaystyle\sum_{k=...}(2m_{odd,\theta}\dot{\theta}_0\dot{\theta}_{k1}+2m_{eve,\theta}\dot{\theta}_0\dot{\theta}_{k2}+
m_{odd,\theta}\dot{\theta}_{k1}^2+m_{eve,\theta}\dot{\theta}_{k2}^2+2m_{odd,\theta}\dot{\theta}_{k1}\dot{\theta}_{k2})\\
(m_{b\theta})\dot{\theta}_0^2+
\displaystyle\sum_{k=...}(2m_{odd,\theta}\dot{\theta}_0\dot{\theta}_{k1}+2m_{eve,\theta}\dot{\theta}_0\dot{\theta}_{k2}+
m_{odd,\theta}\dot{\theta}_{k1}^2+m_{eve,\theta}\dot{\theta}_{k2}^2+2m_{odd,\theta}\dot{\theta}_{k1}\dot{\theta}_{k2})\\
-\displaystyle\sum_{k=lg,rg}(2m_{\theta\theta1}\dot{\theta}_0\dot{\theta}_{k1}+2m_{\theta\theta2}\dot{\theta}_0\dot{\theta}_{k2}+m_{\theta\theta1}\dot{\theta}_{k1}^2+m_{\theta\theta2}\dot{\theta}_{k2}^2+2m_{\theta\theta2}\dot{\theta}_{k1}\dot{\theta}_{k2})-\displaystyle\sum_{k=la,ra}(2m_{\theta\theta3}\dot{\theta}_0\dot{\theta}_{k2}+2m_{\theta\theta3}\dot{\theta}_{k1}\dot{\theta}_{k2}+m_{\theta\theta3}\dot{\theta}_{k2}^2)
\end{bmatrix}\\
\\
&\mathrm{C}_{lg}=
\begin{bmatrix}
m_{\theta\theta1,lg}\dot{\theta}_0^2-2m_{\theta\theta3,lg}\dot{\theta}_0\dot{\theta}_{k2,lg}-2m_{\theta\theta3,lg}\dot{\theta}_{k1,lg}\dot{\theta}_{k2,lg}-m_{\theta\theta3,lg}\dot{\theta}_{k2,lg}^2\\
m_{\theta\theta2,lg}\dot{\theta}_0^2+2m_{\theta\theta3,lg}\dot{\theta}_0\dot{\theta}_{k1,lg}+m_{\theta\theta3,lg}\dot{\theta}_{k1,lg}^2
\end{bmatrix}\\
\\
&\mathrm{C}_{rg}=
\begin{bmatrix}
m_{\theta\theta1,rg}\dot{\theta}_0^2-2m_{\theta\theta3,rg}\dot{\theta}_0\dot{\theta}_{k2,rg}-2m_{\theta\theta3,rg}\dot{\theta}_{k1,rg}\dot{\theta}_{k2,rg}-m_{\theta\theta3,rg}\dot{\theta}_{k2,rg}^2\\
m_{\theta\theta2,rg}\dot{\theta}_0^2+2m_{\theta\theta3,rg}\dot{\theta}_0\dot{\theta}_{k1,rg}+m_{\theta\theta3,rg}\dot{\theta}_{k1,rg}^2
\end{bmatrix}\\
\\
&\mathrm{C}_{la}=
\begin{bmatrix}
-2m_{\theta\theta3,la}\dot{\theta}_0\dot{\theta}_{k2,la}-2m_{\theta\theta3,lg}\dot{\theta}_{k1,la}\dot{\theta}_{k2,la}-m_{\theta\theta3,la}\dot{\theta}_{k2,la}^2\\
m_{\theta\theta2,la}\dot{\theta}_0^2+2m_{\theta\theta3,la}\dot{\theta}_0\dot{\theta}_{k1,la}+m_{\theta\theta3,la}\dot{\theta}_{k1,la}^2
\end{bmatrix}\\
\\
&\mathrm{C}_{ra}=
\begin{bmatrix}
-2m_{\theta\theta3,ra}\dot{\theta}_0\dot{\theta}_{k2,ra}-2m_{\theta\theta3,rg}\dot{\theta}_{k1,ra}\dot{\theta}_{k2,ra}-m_{\theta\theta3,ra}\dot{\theta}_{k2,ra}^2\\
m_{\theta\theta2,la}\dot{\theta}_0^2+2m_{\theta\theta3,la}\dot{\theta}_0\dot{\theta}_{k1,la}+m_{\theta\theta3,la}\dot{\theta}_{k1,la}^2
\end{bmatrix}\\
\end{aligned}
$$
