...
| 速度  | Ts (aerial) | Tc (contact) | Stance | T    |
| ----- | ----------- | ------------ | ------ | ---- |
| 5 m/s | 0.16        | 0.18         |        | 0.68 |
| 6 m/s |             |              |        |      |
|       |             |              |        |      |
| 8 m/s | 0.135       | 0.125        |        | 0.52 |
...
- Faster top running speeds are achieved with greater ground forces not more rapid leg movements
  ...
  <img src="https://s2.loli.net/2022/07/21/KlxjybSzJcDnsiA.png" alt="tstw2" style="zoom:200%;" />
