...
| 类型 | 质量 | 冲击力 | 接触时间 | 速度 | 最高速度 |
| ---- | -------- | ---------------- | ------------ | ------------- | ------------- |
| 乒乓球 | 0.0027 kg | 2.94 N | 1.4 ms | 20 m/s | 47.2 m/s |
| 羽毛球 | 0.005 kg |  | 4 ms | 56 m/s | 118 m/s | 
| 高尔夫 | 0.045 kg | 10kN | 0.42 ms | 60 m/s | 91 m/s | 
| 网球 | 0.057 kg | 1200 N | 5.2 ms | 60 m/s | 70 m/s | 
| 棒球 | 0.145 kg | 20 kN | 0.8 ms | 60m/s | 47 m/s | 
| 排球 | 0.27 kg | 402 N | 12.7 ms | 60m/s | 38 m/s | 
| 足球 | 0.4 kg | 1100 N | 9.3 ms | 60m/s | 61 m/s | 
...
$$
\begin{aligned}
k\sim \frac{\tau}{\gamma^2I_m+I_{link}} \qquad
\Rightarrow \qquad
k=c\frac{\tau}{\gamma^2I_m+I_{link}}
\end{aligned}
$$
因此冲量可以表示为
$$
\Lambda = M_c\Delta \dot{x}=\dot q_m (\gamma^2I_m+I_{link})(1-e^{-\frac{cf\gamma^{g+1}}{\gamma^2I_m+I_{link}}})
$$
假设一些参数并带入，得到一组测试结果
```
c = 0.02
...
qm = 100*np.pi
```
<div style="text-align: center"><img src="https://cdn.jsdelivr.net/gh/Stylite-Y/MyTypora@master/img/md/impact-y-2022-12-07-15-16-34.png .png" alt="impact-y-2022-12-07-15-16-34.png " > </div>