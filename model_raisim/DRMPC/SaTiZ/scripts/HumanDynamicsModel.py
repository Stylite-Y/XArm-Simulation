"""
1. 2023.03.02:
        - 四连杆人体模型（多参数优化）: 从上到下的多杆倒立摆动力学方程建模方法
2. 2023.05.30:
...
## HumanModelHalf3: 从上到下的多杆倒立摆动力学方程建模方法
def HumanModelHalf3():
    ...
    htheta1 = theta0 + theta1
    htheta2 = theta0 + theta1 + theta2
    htheta3 = theta0 + theta1 + theta2 + theta3
    htheta4 = theta0 + theta1 + theta2 + theta3 + theta4

    x1 = l[0]* sin(theta0)       # link 2 x mcp
    z1 = l[0]* cos(theta0)       # link 2 y mcp
    x2 = L[0]* sin(theta0) + l[1]* sin(htheta1)       # link 2 x mcp
    z2 = L[0]* cos(theta0) + l[1]* cos(htheta1)       # link 2 y mcp
    x3 = L[0]* sin(theta0) + L[1]* sin(htheta1) + l[2]* sin(htheta2)       # link 2 x mcp
    z3 = L[0]* cos(theta0) + L[1]* cos(htheta1) + l[2]* cos(htheta2)       # link 2 y mcp
    x4 = L[0]* sin(theta0) + L[1]* sin(htheta1) + L[2]* sin(htheta2) + l[3]* sin(htheta3)       # link 2 x mcp
    z4 = L[0]* cos(theta0) + L[1]* cos(htheta1) + L[2]* cos(htheta2) + l[3]* cos(htheta3)       # link 2 y mcp
    x5 = L[0]* sin(theta0) + L[1]* sin(htheta1) + L[2]* sin(htheta2) + \
        L[3]* sin(htheta3) + l[4]* sin(htheta4)       # link 2 x mcp
    z5 = L[0]* cos(theta0) + L[1]* cos(htheta1) + L[2]* cos(htheta2) + \
        L[3]* cos(htheta3) + l[4]* cos(htheta4)

    # velocity relationship
    dhtheta0 = dtheta0
    dhtheta1 = dtheta0 + dtheta1
    dhtheta2 = dtheta0 + dtheta1 + dtheta2
    dhtheta3 = dtheta0 + dtheta1 + dtheta2 + dtheta3
    dhtheta4 = dtheta0 + dtheta1 + dtheta2 + dtheta3 + dtheta4

    dx1 = l[0]* cos(theta0)*dtheta0       # link 2 x mcp
    dz1 = - l[0]* sin(theta0)*dtheta0       # link 2 y mcp
    dx2 = L[0]* cos(theta0)*dtheta0 + l[1]* cos(htheta1)*(dhtheta1)       # link 2 x mcp
    dz2 = - L[0]* sin(theta0)*(dtheta0) - l[1]* sin(htheta1)*(dhtheta1)      # link 2 y mcp
    dx3 = L[0]* cos(theta0)*dtheta0 + L[1]* cos(htheta1)*(dhtheta1) + \
          l[2]* cos(htheta2)*(dhtheta2)       # link 2 x mcp
    dz3 = - L[0]* sin(theta0)*dtheta0 - L[1]* sin(htheta1)*(dhtheta1) - \
          l[2]* sin(htheta2)*(dhtheta2)       # link 2 y mcp
    dx4 = L[0]* cos(theta0)*dtheta0 + L[1]* cos(htheta1)*(dhtheta1) + \
          L[2]* cos(htheta2)*(dhtheta2) + l[3]* cos(htheta3)*(dhtheta3)       # link 2 x mcp
    dz4 = - L[0]* sin(theta0)*dtheta0 - L[1]* sin(htheta1)*(dhtheta1) - \
          L[2]* sin(htheta2)*(dhtheta2) - l[3]* sin(htheta3)*(dhtheta3)       # link 2 y mcp
    dx5 = L[0]* cos(theta0)*dtheta0 + L[1]* cos(htheta1)*(dhtheta1) + \
          L[2]* cos(htheta2)*(dhtheta2) + L[3]* cos(htheta3)*(dhtheta3) + \
          l[4]* cos(htheta4)*(dhtheta4)       # link 2 x mcp
    dz5 = - L[0]* sin(theta0)*dtheta0 - L[1]* sin(htheta1)*(dhtheta1) - \
          L[2]* sin(htheta2)*(dhtheta2) - L[3]* sin(htheta3)*(dhtheta3) - \
          l[4]* sin(htheta4)*(dhtheta4)
    ...
    def get_coriolis_term(f):
        print("Coriolis term")
        s = [dtheta0, dtheta1, dtheta2, dtheta3, dtheta4]
        ss = [sym('O0\''), sym('O1\''), sym('O2\''), sym('O3\'') , sym('O4\'')]
...
## 2023.03.02四连杆人体模型（多参数优化）: 从上到下的多杆倒立摆动力学方程建模方法
def FourLinkMultiParams():
    ...
    # define geometry and mass parameter
    # body, thigh, shank, uparm, forearm
    m = [sym('m'+str(i)) for i in range(4)]
    I = [sym('I'+str(i)) for i in range(4)]
    L = [sym('L'+str(i)) for i in range(4)]
    l = [sym('l'+str(i)) for i in range(4)]
    g = sym('g')
    ...
    x3 = L[0]* sin(theta0) + L[1]* sin(htheta1) + L[2]* sin(htheta2) + l[3]* sin(htheta3)       # link 2 x mcp
    z3 = L[0]* cos(theta0) + L[1]* cos(htheta1) + L[2]* cos(htheta2) + l[3]* cos(htheta3)       # link 2 y mcp
    ...
    T1 = 0.5 * m[1] * (dx1**2 + dz1**2) + 0.5 * I[1] * (dhtheta1**2)
    T2 = 0.5 * m[2] * (dx2**2 + dz2**2) + 0.5 * I[2] * (dhtheta2**2)
    T3 = 0.5 * m[3] * (dx3**2 + dz3**2) + 0.5 * I[3] * (dhtheta3**2)
    ...
    def get_coriolis_term(f):
        print("Coriolis term")
        s = [dtheta0, dtheta1, dtheta2, dtheta3]
        ss = [sym('O0\''), sym('O1\''), sym('O2\''), sym('O3\'')]
...
def TwoLinkMultiParams():
    ...
    # define geometry and mass parameter
    # body, thigh, shank, uparm, forearm
    m = [sym('m'+str(i)) for i in range(2)]
    I = [sym('I'+str(i)) for i in range(2)]
    L = [sym('L'+str(i)) for i in range(2)]
    l = [sym('l'+str(i)) for i in range(2)]
    g = sym('g')
